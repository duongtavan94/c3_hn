...
@section('title', 'Quản lý Thông tin giáo dục')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Quản lý Thông tin giáo dục</li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($c->cc == 1)
                                                            ...
                                                            <a href="#" title="Ẩn" id="cc" data-id="{{ $c->id }}">

                                                                <span id="cc{{ $c->id }}"><span class="label label-success">Hiện</span></span>

                                                            </a>

                                                        @else

                                                            <a href="#" title="Hiện" id="cc" data-id="{{ $c->id }}">

                                                                <span id="cc{{ $c->id }}"><span class="label label-danger">Ẩn</span></span>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#status', function(){
        ...
        $.post('{{ route('admin.intro.cc') }}', {id:id}, function(data){

            if (data.cc == 1)

            {

                $('#cc'+id).html('<span class="label label-success">Hiện</span>');

            } else {

                $('#cc'+id).html('<span class="label label-danger">Ẩn</span>');
