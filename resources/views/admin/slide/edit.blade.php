                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    placeholder="Nhập tên" name="name_vi" value="{{ $slide->name_vi }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label">Con số: </label>

                                                <div class="col-md-8">

                                                    <input type="number" class="form-control"

                                                    placeholder="Nhập vị trí" name="conso"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <select class="form-control" name="dislay">
                                                        ...
                                                        {{-- <option <?php if($slide->dislay ==4) echo 'selected="selected"';?> value="4">

                                                            Đối tác

                                                        </option> --}}
                                                        <option <?php if($slide->dislay ==5) echo 'selected="selected"';?> value="5">

                                                            Bài trang chủ

                                                        </option>
                                                        <option <?php if($slide->dislay ==6) echo 'selected="selected"';?> value="6">
