...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <a href="{{ route('admin.invest.create') }}" class="btn btn-primary">
                                        ...
                                        <table class="table table-striped table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $c->updated_at }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.invest.update', $c->id)}}">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="{{ route('admin.invest.destroy', $c->id) }}"
                                                            type="button"
...
<script type="text/javascript">
    ...
    $(document).on('click', '#status', function(){
        ...
        var id = $(this).data('id');
        $.post('{{ route('admin.invest.status') }}', {id:id}, function(data){
            if (data.status == 1)
            {
