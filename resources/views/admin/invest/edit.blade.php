                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    action="{{ route('admin.invest.postUpdate', $invest->id) }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    placeholder="Nhập tên" name="name" value="{{ $invest->name }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    name="description" id="editor1">{{ $invest->description }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-footer">
                                            <div class="row">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    ...
                                                    href="{{ route('admin.invest.create') }}">
                                                        Hủy
                                                    </a>
