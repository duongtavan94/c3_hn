...
<div class="bannergd">
    ...
    <img src="{{ asset('images/bannertt.png') }}" alt="">
...
<div class="contengdcs">
    ...
    <div class="container">
        ...
        <div class="tieude">
            ...
            <h2 class="tdh2">{{ trans('home.timkiem') }}: {{$input}}</h2>

        </div>

        <div class="row">

            @foreach ($search as $key => $c)
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 favorite">
                                ...
                                <div class="kmcian">
                                    ...
                                    <p class="d1">{{$c->created_at->format('j')}}</p>

                                    <p class="d2">{{$c->created_at->format('F')}}</p>
